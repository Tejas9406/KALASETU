...
export const env = {
  ...
  GROQ_API_KEY: process.env.GROQ_API_KEY || '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',
  ...
  JWT_SECRET: process.env.JWT_SECRET || 'kala_setu_jwt_secure_key_sih_2026_production_auth_secret',
